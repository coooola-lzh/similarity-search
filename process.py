...
print("Import data paths with specified path prefix:{}".format(prefix))
...
print("Start merging the data files...")
t1 = time.time()
finished_word_cnt = 0
...
print("Start pickling the dictionary (from url to index).")
t1 = time.time()
